...
<template>
  <div
      ...
      class="group"
      :class="[
      `${bgColor} relative w-full h-[300px] border-red-100 rounded-lg p-5 flex flex-col justify-between border transition-all duration-700 hover:shadow-xl`,
      visible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-3',
    ]"
  >
    <img
        src="@/assets/img/pillow.jpg"
